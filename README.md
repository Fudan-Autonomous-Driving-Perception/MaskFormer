# 实验
|实验|数据集|服务器|iter|ims_per_batch|lr|交通标志牌 杆状物 路面标识(分辨率）|速度
|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:
 MaskFormer-Swin-Tiny| A2D2 | V100 | 160000 | 16 | WarmupPolyLR(0.0001) | 78.32 53.30 70.73(512x512) | 22.17FPS
 MaskFormer-Swin-Small| A2D2 | V100 | 160000 | 16 | WarmupPolyLR(0.0001) | 80.19 54.92 73.43(512x512) | 16.86FPS
